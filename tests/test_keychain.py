...
class TestKeychainFileBackend(unittest.TestCase):
    ...
    def test_provider_key_round_trips_and_survives_a_restart(self):
        kc = file_backed(secrets_path=self.path)
    ...
    def test_no_stray_temp_file_after_write(self):
        kc = file_backed(secrets_path=self.path)
    ...
    def test_a_key_is_never_returned_for_another_provider(self):
    ...
    def test_role_scoped_key_round_trips(self):
    ...
    def test_environment_variable_still_resolves(self):
        kc = file_backed(secrets_path=self.path)
    ...
    def test_stored_key_wins_over_environment(self):
        kc = file_backed(secrets_path=self.path)
    ...
    def test_unwritable_store_raises_a_coded_error(self):
        kc = file_backed(secrets_path=self.path)
...
class TestRoleKeyRename(unittest.TestCase):
    ...
    def test_a_role_key_follows_the_renamed_role(self):
        kc = file_backed(secrets_path=self.path)
    ...
    def test_renaming_a_role_with_no_key_changes_nothing(self):
        kc = file_backed(secrets_path=self.path)
    ...
    def test_a_provider_key_is_not_touched_by_a_role_rename(self):
